...
def test_bad_boids_regression():
    regression_data=yaml.load(open(os.path.join(
        ...
        'fixtures/regression_fixtures.yml')))
    
    pos_before = [regression_data['before'][0],
            regression_data['before'][1]]
    pos_after = [regression_data['after'][0],
            regression_data['after'][1]]
    vel_before = [regression_data['before'][2],
            regression_data['before'][3]]
    vel_after = [regression_data['after'][2],
            regression_data['after'][3]]
